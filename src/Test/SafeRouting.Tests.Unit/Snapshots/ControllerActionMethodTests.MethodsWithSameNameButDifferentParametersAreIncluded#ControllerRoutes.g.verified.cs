...
namespace Routes
{
  namespace Controllers
  {
    ...
    public static class Products
    {
      ...
      /// </summary>
      public static Support.Controllers_Products.Index2RouteValues Index(string someValue)
      {
        return new Support.Controllers_Products.Index2RouteValues(new global::Microsoft.AspNetCore.Routing.RouteValueDictionary()
        {
          ["area"] = "",
          ["someValue"] = someValue
        });
  ...
  namespace Support.Controllers_Products
  {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("SafeRouting.Generator", "1.0.0.0")]
    [global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed class Index2RouteValues : global::SafeRouting.IControllerRouteValues
    {
      /// <summary>
      /// Initialises a new instance of the <see cref="Index2RouteValues"/> class.
      /// </summary>
      /// <param name="routeValues">The initial values for the route.</param>
      public Index2RouteValues(global::Microsoft.AspNetCore.Routing.RouteValueDictionary routeValues)
      {
        RouteValues = routeValues;
      }
      ...
      /// </summary>
      public Index2.ParameterData Parameters { get; } = new Index2.ParameterData();
      /// <summary>
      ...
      public bool Remove<T>(global::SafeRouting.RouteKey<Index2.ParameterData, T> key) => RouteValues.Remove(key.Name);
      /// <summary>
      ...
      public void Set<T>(global::SafeRouting.RouteKey<Index2.ParameterData, T> key, T value) => RouteValues[key.Name] = value;
      /// <summary>
      /// Sets a parameter value for the route.
      /// </summary>
      /// <param name="key">The key for the route.</param>
