...
namespace Routes
{
  namespace Pages
  {
    ...
    public static class Products_Foo_Edit
    {
      /// <summary>
      /// Generates route values for <see cref="global::EditModel.OnGet()"/>.
      /// </summary>
      public static Support.Pages_Products_Foo_Edit.GetRouteValues Get()
      {
        return new Support.Pages_Products_Foo_Edit.GetRouteValues(new global::Microsoft.AspNetCore.Routing.RouteValueDictionary()
        {
          ["area"] = ""
        });
      }
  ...
  namespace Support.Pages_Products_Foo_Edit
  {
    /// <summary>
    ...
    public sealed class GetRouteValues : global::SafeRouting.IPageRouteValues
    {
      ...
      /// </summary>
      public string PageName => "/Products/Foo/Edit";
      /// <summary>
