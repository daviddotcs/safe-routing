...
namespace Routes
{
  namespace Controllers
  {
    ...
    {
      /// <summary>
      /// Generates route values for <see cref="global::ProductsController.Index(int, global::System.Collections.Generic.Dictionary{string, object})"/>.
      /// </summary>
      public static Support.Controllers_Products.IndexRouteValues Index(int id, global::System.Collections.Generic.Dictionary<string, object> bar, string? name, global::System.Collections.Generic.Dictionary<string, object>? foo)
      {
  ...
  namespace Support.Controllers_Products
  {
    ...
    /// <summary>
    /// Represents route values for routes to <see cref="global::ProductsController.Index(int, global::System.Collections.Generic.Dictionary{string, object})"/>.
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("SafeRouting.Generator", "1.0.0.0")]
    [global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed class IndexRouteValues : global::SafeRouting.IControllerRouteValues
    {
      ...
      /// </summary>
      /// <param name="key">The key for the route.</param>
      public global::System.Collections.Generic.Dictionary<string, object> this[global::SafeRouting.RouteKey<Index.ParameterData, global::System.Collections.Generic.Dictionary<string, object>> key] { set => RouteValues[key.Name] = value; }
      /// <summary>
      /// Sets a parameter value for the route.
      /// </summary>
      /// <param name="key">The key for the route.</param>
    ...
    {
      /// <summary>
      /// Represents route keys for parameters to <see cref="global::ProductsController.Index(int, global::System.Collections.Generic.Dictionary{string, object})"/>.
      /// </summary>
      [global::System.CodeDom.Compiler.GeneratedCode("SafeRouting.Generator", "1.0.0.0")]
      [global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
      ...
      {
        /// <summary>
        /// Route key for the <c>id</c> parameter in <see cref="global::ProductsController.Index(int, global::System.Collections.Generic.Dictionary{string, object})"/>.
        /// </summary>
        public global::SafeRouting.RouteKey<ParameterData, int> Id { get; } = new global::SafeRouting.RouteKey<ParameterData, int>("id");
        
        /// <summary>
        /// Route key for the <c>bar</c> parameter in <see cref="global::ProductsController.Index(int, global::System.Collections.Generic.Dictionary{string, object})"/>.
        /// </summary>
