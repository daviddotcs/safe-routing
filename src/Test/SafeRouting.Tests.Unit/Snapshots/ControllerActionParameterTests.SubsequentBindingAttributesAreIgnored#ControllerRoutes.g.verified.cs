...
namespace Routes
{
  namespace Controllers
  {
    ...
    public static class Products
    {
      ...
      /// </summary>
      public static Support.Controllers_Products.IndexRouteValues Index(string includedParameter)
      {
        return new Support.Controllers_Products.IndexRouteValues(new global::Microsoft.AspNetCore.Routing.RouteValueDictionary()
        {
          ["area"] = "",
          ["includedParameter"] = includedParameter
        });
      }
    }
  }
  ...
  namespace Support.Controllers_Products
  {
    ...
    namespace Index
    {
      ...
      {
        /// <summary>
        /// Route key for the <c>includedParameter</c> parameter in <see cref="global::ProductsController.Index(string, string)"/>.
        /// </summary>
        public global::SafeRouting.RouteKey<ParameterData, string> IncludedParameter { get; } = new global::SafeRouting.RouteKey<ParameterData, string>("includedParameter");

        /// <summary>
        /// Route key for the <c>excludedParameter</c> parameter in <see cref="global::ProductsController.Index(string, string)"/>.
        /// </summary>
        public global::SafeRouting.RouteKey<ParameterData, string> ExcludedParameter { get; } = new global::SafeRouting.RouteKey<ParameterData, string>("excludedParameter");
      }
    }
  }
}
