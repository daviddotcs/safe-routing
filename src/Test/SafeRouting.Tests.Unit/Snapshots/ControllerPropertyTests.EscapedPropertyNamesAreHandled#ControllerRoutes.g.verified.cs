...
namespace Routes
{
  ...
  namespace Support.Controllers_Products
  {
    ...
    {
      /// <summary>
      /// Route key for the property <see cref="global::ProductsController.@class"/>.
      /// </summary>
      public global::SafeRouting.RouteKey<PropertyData, string?> @class { get; } = new global::SafeRouting.RouteKey<PropertyData, string?>("class");
    }
