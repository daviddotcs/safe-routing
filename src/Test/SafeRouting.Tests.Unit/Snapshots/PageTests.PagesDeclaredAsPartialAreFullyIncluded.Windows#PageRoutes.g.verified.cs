...
namespace Routes
{
  namespace Pages
  {
    ...
    public static class Index
    {
      ...
      /// <summary>
      /// Generates route values for <see cref="global::IndexModel.OnPost()"/>.
      /// </summary>
      public static Support.Pages_Index.PostRouteValues Post()
      {
        return new Support.Pages_Index.PostRouteValues(new global::Microsoft.AspNetCore.Routing.RouteValueDictionary()
        {
          ["area"] = ""
        });
      }
  ...
  namespace Support.Pages_Index
  {
    ...
    /// <summary>
    /// Represents route values for routes to <see cref="global::IndexModel.OnPost()"/>.
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("SafeRouting.Generator", "1.0.0.0")]
    [global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
