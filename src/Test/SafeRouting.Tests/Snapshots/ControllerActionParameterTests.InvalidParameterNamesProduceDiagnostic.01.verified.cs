...
namespace Routes
{
  namespace Controllers
  {
    ...
    public static class Products
    {
      ...
      /// </summary>
      public static Support.Controllers_Products.IndexRouteValues Index(string myValue)
      {
        var routeInfo = new Support.Controllers_Products.IndexRouteValues();
        routeInfo.RouteValues["area"] = "";
        routeInfo.RouteValues[routeInfo.Parameters.MyValue.Name] = myValue;
        return routeInfo;
      }
    }
  }
  ...
  namespace Support.Controllers_Products
  {
    ...
    namespace Index
    {
      ...
      {
        /// <summary>
        /// Route key for the <c>myValue</c> parameter in <see cref="global::ProductsController.Index(string)"/>.
        /// </summary>
        public global::SafeRouting.RouteKey<ParameterData, string> MyValue { get; } = new global::SafeRouting.RouteKey<ParameterData, string>("myValue");
      }
    }
  }
}
