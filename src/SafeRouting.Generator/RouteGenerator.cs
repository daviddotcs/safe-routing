...
namespace SafeRouting.Generator
{
  ...
  public sealed class RouteGenerator : IIncrementalGenerator
  {
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
      ...
      context.RegisterConditionalOutput(isGlobalUsingsSupportedProvider, context =>
      {
...
global using static SafeRouting.Extensions.RouteValueExtensions;";
      ...
      context.RegisterConditionalOutput(isUnsupportedLanguageVersionProvider, context =>
      {
